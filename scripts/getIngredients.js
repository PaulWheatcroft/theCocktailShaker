...
/* ----------- Set the navigation buttons to disabled if applicable */
    if (Object.keys(cocktailData.drinks).length === 1) {
        ...
        <a href="index.html"><button id="home" class="pointer pointer-home"><a href="index.html" aria-label="Home"><i class="fas fa-home"></i></button></a>
        <button id="show-how" class="pointer pointer-information animate__animated  animate__headShake animate__delay-1s animate__repeat-3" aria-label="Show Ingredients"><i class="fas fa-info"></i></button>
        ...
        cocktailNavButtons = `
        <button id="click-back" class="pointer pointer-left pointer-disabled" onclick="previousCocktail()" aria-label="Previous Cocktail" disabled><i class="fas fa-hand-point-left"></i></button>
        <a href="index.html"><button id="home" class="pointer pointer-home" aria-label="Home"><a href="index.html"><i class="fas fa-home"></i></button></a>
        <button id="show-how" class="pointer pointer-information animate__animated  animate__headShake animate__delay-1s animate__repeat-3" aria-label="Show Ingredients"><i class="fas fa-info"></i></button>
        <button id="click-next" class="pointer pointer-right" onclick="nextCocktail()" aria-label="Next Cocktail"><i class="fas fa-hand-point-right"></i></button>
        `;
        ...
        cocktailNavButtons = `
        <button id="click-back" class="pointer pointer-left" onclick="previousCocktail()" aria-label="Previous Cocktail"><i class="fas fa-hand-point-left"></i></button>
        <a href="index.html"><button id="home" class="pointer pointer-home" aria-label="Home"><a href="index.html"><i class="fas fa-home"></i></button></a>
...
/* ----------- Construct the HTML to view how to make the cocktail */
            ...
            <div id="nav-buttons">
            <button id="go-back" class="pointer pointer-left" onclick="previousCocktail()" aria-label="Back to Cocktails"><i class="fas fa-hand-point-left"></i></button>
            <a href="index.html"><button id="home" class="pointer pointer-home" aria-label="Home"><a href="index.html"><i class="fas fa-home"></i></button></a>
            <button id="email-me" class="pointer pointer-information"><a href="email.html" aria-label="Email the Instructions"><i class="fas fa-envelope"></i></a></button>
